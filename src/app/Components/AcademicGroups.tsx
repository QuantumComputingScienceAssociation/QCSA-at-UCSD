...
const InfiniteCarousel = ({ direction = 'left' }: { direction?: 'left' | 'right' }) => {
  ...
  const sponsors = [
    ...
    // TODO: Add UCSD-specific research groups (e.g. UCSD Physics, CSE Quantum, Wallman Lab)
    { name: 'UC San Diego Jacobs School of Engineering', logo: '/images/UC San Diego.png', url: 'https://jacobsschool.ucsd.edu/' },
  ];
...
<div className="sr-only">
  ...
  <ul>
    {sponsors.map((sponsor, index) => (
      ...
      <section className="w-full max-w-full py-8" style={{ backgroundColor: '#FDFAF4' }} aria-label="Sponsor carousel" >
        <div className="w-full max-w-full px-4">
          ...
          >
            ...
            <div 
              ...
              style={{ background: 'linear-gradient(to right, #FDFAF4, transparent)' }}
              aria-hidden="true"
            ></div>
            <div 
