...
export default function Orb({ hue = 240, hoverIntensity = 0.2, rotateOnHover = true, forceHoverState = true }: OrbProps) {
  ...
  const frag = /* glsl */ `
    ...
    const vec3 baseColor1 = vec3(1.000000, 0.803922, 0.000000); // UCSD gold  #FFCD00
    const vec3 baseColor2 = vec3(0.000000, 0.415686, 0.588235); // QCSA mid-blue #006A96
    const vec3 baseColor3 = vec3(0.000000, 0.243137, 0.454902); // UCSD navy #003E74
